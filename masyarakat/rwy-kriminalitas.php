        ...
        <div class="container">
            ...
            <div class="panel panel-container"
                ...
                <div class="bootstrap-table">
                    ...
                    $det = mysqli_query($conn, "SELECT * from tbl_pengaduan_kriminalitas a, tbl_kriteria b, tbl_kecamatan c WHERE a.id_kriteria=b.id_kriteria AND a.id_kecamatan=c.id_kecamatan AND a.id_akun='$id_akun' order by a.id_pengaduan DESC");
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body p-4">
                                        <?php
                                        $query = mysqli_query($conn, "SELECT * FROM tbl_pengaduan_kriminalitas WHERE id_pengaduan='$d[id_pengaduan]'");
