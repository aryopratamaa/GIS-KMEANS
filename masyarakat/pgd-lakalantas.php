...
if (isset($_GET['aksi'])) {
	if ($_GET['aksi']=="kirim") {
		...
		mysqli_query($conn,"insert into tbl_pengaduan_lakalantas(id_akun,foto,tgl_kejadian,id_kriteria,id_lalulintas,alamat,telepon,ket_pengaduan,status,sumber) values('$id_akun','$foto','$tgl_kejadian','$id_kriteria','$id_lalulintas','$alamat','$telepon','$ket_pengaduan','Verifikasi','Masyarakat')");
		header("location:rwy-lakalantas?pesan=berhasil");
	}
}
	...
	<section id="contact" class="contact">
		<div class="container">
			...
			<ol class="breadcrumb" style="padding: 20px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
				...
				<li class="breadcrumb-item active" aria-current="page" style="padding-top:5px;">Pengaduan Lakalantas</li>
			</ol>
			...
			<div class="panel panel-container" style="padding: 50px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
				<div class="bootstrap-table">
					...
					<div style='margin-top:1px;' class='alert alert-primary' role='alert'><span class='fa fa-info-circle'></span> &nbsp; Upload kejadian mengenai Lakalantas, pengaduan anda sangat membantu . .</div><hr><br>
					...
					<form action="pgd-lakalantas?aksi=kirim" method="post" enctype="multipart/form-data">
						...
						<div class='form-group'>
							...
							<select class='form-control' name='id_lalulintas' autocomplete='off'>
								...
								while($b=mysqli_fetch_array($b1)){
									...
									<option value="<?php echo $b['id_lalulintas'] ?>"><?php echo $b['nama_lalulintas'] ?></option>
