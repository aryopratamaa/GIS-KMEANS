    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Analisa Metode</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="analisa-kriminalitas">Kriminalitas</a></li>
              <li><a href="analisa-lakalantas">Lakalantas</a></li>
            </ul>
          </li>
          ...
          ?>
          <li class="dropdown"><a href="#" class="getstarted scrollto" style="background-color: #191970; box-shadow: 2px 2px 10px #888888; padding:13px;"><span class="fa fa-user"></span> &emsp;Hy, <?php echo $d['nama_lengkap'] ?>  <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
