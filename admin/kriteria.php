		...
		<div class="container">
			...
			<div class="panel panel-container"
				...
				<div class="bootstrap-table">
					<a href="kriteria-aksi?aksi=tambah" class="btn btn-primary"><i class="fa fa-plus"></i>&emsp; Tambah
						Data</a>
					<br />
					<br />
					...
					<table class="table table-hover table-bordered">
						...
						while ($b = mysqli_fetch_array($brg)) {
							...
							<tr>
								...
								<td class="text-center">
									<a href="kriteria-aksi?id_kriteria=<?php echo $b['id_kriteria']; ?>&aksi=ubah"
										class="btn btn-primary"><span class="fa fa-pencil"></span></a>
									<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='kriteria-proses?id_kriteria=<?php echo $b['id_kriteria']; ?>&proses=proses-hapus' }"
