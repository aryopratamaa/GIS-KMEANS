  ...
  <section id="contact" class="contact">
    <div class="container">
      ...
      <ol class="breadcrumb" style="padding: 20px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
        ...
        <li class="breadcrumb-item active" aria-current="page" style="padding-top:5px;">Detail Kriminalitas</li>
        <li class="breadcrumb-item active" aria-current="page" style="padding-top:5px;"><a
            href="kriminalitas">Kembali</a></li>
      </ol>
      ...
      <div class="panel panel-container"
        ...
        <div class="bootstrap-table">
          ...
          <?php
          $det = mysqli_query($conn, "SELECT * from tbl_kriteria c, tbl_kecamatan d, tbl_kriminalitas e WHERE e.id_kriteria=c.id_kriteria AND e.id_kecamatan=d.id_kecamatan AND d.id_kecamatan='$_GET[id_kecamatan]' AND c.keterangan='Kriminalitas'");
          while ($d = mysqli_fetch_array($det)) { ?>
            ...
            <div class="collapse" id="collapseExample<?php echo $d['id_kriteria'] ?>">
              <div class="row">
                <?php
                //pengaduan
                $de = mysqli_query($conn, "SELECT * from tbl_pengaduan_kriminalitas a, tbl_kriteria b, tbl_kecamatan c, tbl_akun d WHERE a.id_kriteria=b.id_kriteria AND a.id_kecamatan=c.id_kecamatan AND a.id_akun=d.id_akun AND a.id_kriteria='$d[id_kriteria]' AND a.id_kecamatan='$_GET[id_kecamatan]' AND NOT a.status='inValid' OR a.status='Verifikasi' ORDER BY a.id_pengaduan DESC");
