		...
		<div class="container" data-aos="fade-up">
			...
			<div class="panel panel-container" style="padding: 50px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
				<div class="bootstrap-table">
					<a href="pengguna-aksi?aksi=tambah" class="btn btn-primary"><i class="fa fa-plus"></i>&emsp; Tambah Data</a>
					<br/>
					<br/>
						...
						<table class="table table-hover table-bordered">
							...
							while($b=mysqli_fetch_array($brg)){
								...
								<tr>
									...
									<td class="text-center"><?php echo $b['password'] ?></td>
									<td class="text-center"><?php echo $b['level'] ?></td>
									
									
									<td class="text-center">
										<a href="pengguna-aksi?id_akun=<?php echo $b['id_akun']; ?>&aksi=ubah" class="btn btn-primary"><span class="fa fa-pencil"></span></a>

										<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='pengguna-proses?id_akun=<?php echo $b['id_akun']; ?>&proses=proses-hapus' }" class="btn btn-success"><span class="fa fa-trash"></span></a>
									</td>
								</tr>		
								<?php 
							}
