						...
						<div class="bootstrap-table">
							...
							<div class="modal-body">
								<form action="berita-proses?proses=proses-tambah" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label>Tanggal</label>
										<input name="tgl_berita" type="date" class="form-control" autocomplete="off" required
											onsubmit="this.setCustomValidity('')">
									</div>
									<br>
									...
									<div class="form-group">
										...
										<i style="color:red; font-size:13px;">*upload foto dengan extensi jpg. png. jpeg.
											maximal size 10Mb</i>
									</div>
									<br>
									...
									<div class="form-group">
										...
										<td><textarea rows='4' cols='50' class='form-control' name='keterangan' type='text'
												required onsubmit="this.setCustomValidity('')"></textarea></td>
									</div>
									<hr>

									<div class="modal-footer">
										<a href="berita" class="btn btn-primary" type="button"
						...
						<div class="bootstrap-table">
							...
							while ($d = mysqli_fetch_array($det)) {
								...
								<form action="berita-proses?proses=proses-ubah" method="post" enctype="multipart/form-data">
									<table class="table">
										<input type="hidden" readonly class="form-control" name="id_berita"
											value="<?php echo $d['id_berita'] ?>"></td>

										<tr>
											<td>Judul</td>
											<td><input name="judul" type="text" value="<?php echo $d['judul'] ?>"
										...
										<tr>
											<td>Tanggal</td>
											<td><input name="tgl_berita" type="date" value="<?php echo $d['tgl_berita'] ?>"
													class="form-control" autocomplete="off" required
													onsubmit="this.setCustomValidity('')"></td>
										</tr>
										...
										<tr>
											<td>Foto</td>
											<td><input name="foto" type="file" value="<?php echo $d['foto'] ?>"
										...
										<tr>
											<td>Keterangan</td>
											<td><textarea rows='4' cols='50' class='form-control' name='keterangan'
													type='text'><?php echo $d['keterangan'] ?></textarea></td>
										</tr>
