					...
					<div class="panel panel-container" style="padding: 50px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
						<div class="bootstrap-table">
							...
							<div class="modal-body">
								<form action="lakalantas-proses?proses=proses-tambah" method="post" enctype="multipart/form-data">
									...
									<div class="modal-footer">
										<a href="lakalantas" class="btn btn-primary" type="button"data-dismiss="modal">Batal</a>&nbsp;
