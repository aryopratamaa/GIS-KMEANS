							...
							<div class="modal-body">
								<form action="kriteria-proses?proses=proses-tambah" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input name="nama_kriteria" type="text" class="form-control" placeholder="kriteria"
									...
									<div class="modal-footer">
										<a href="kriteria" class="btn btn-primary" type="button"
							...
							while ($d = mysqli_fetch_array($det)) {
								...
								<form action="kriteria-proses?proses=proses-ubah" method="post" enctype="multipart/form-data">
									<table class="table">
										...
										<input type="hidden" readonly class="form-control" name="id_kriteria"
											value="<?php echo $d['id_kriteria'] ?>">

										<tr>
											<td>Kriteria</td>
											<td><input type="text" class="form-control" name="nama_kriteria"
													value="<?php echo $d['nama_kriteria'] ?>"></td>
										</tr>
