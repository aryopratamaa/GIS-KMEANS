							...
							<div class="modal-body">
								<form action="pengguna-proses?proses=proses-tambah" method="post" enctype="multipart/form-data">
									...
									<div class="modal-footer">
										<a href="pengguna" class="btn btn-primary" type="button"
								...
								<form action="pengguna-proses?proses=proses-ubah" method="post" enctype="multipart/form-data">
									<table class="table">
										<input type="hidden" readonly class="form-control" name="id_akun"
											value="<?php echo $d['id_akun'] ?>"></td>

										<tr>
											<td>Nama Lengkap</td>
											<td><input name="nama_lengkap" type="text" value="<?php echo $d['nama_lengkap'] ?>"
										...
										<tr>
											<td>Username</td>
											<td><input name="username" type="text" value="<?php echo $d['username'] ?>"
													class="form-control" autocomplete="off" required
													onsubmit="this.setCustomValidity('')"></td>
										</tr>
										...
										<tr>
											<td>Password</td>
											<td><input name="password" type="password" value="<?php echo $d['password'] ?>"
													class="form-control" autocomplete="off" required
													onsubmit="this.setCustomValidity('')"></td>
										</tr>
