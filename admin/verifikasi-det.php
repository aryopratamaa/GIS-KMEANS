				...
				<div class="bootstrap-table">
					...
					<table class="table">
						...
						<tr>
							...
							<td align="justify"><?php echo $b['ket_pengaduan'] ?></td>
						</tr>
						<tr>
							<td>Foto</td>
							<td> <a href="" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $b['id_pengaduan']; ?>" class="btn btn-primary"><em class="fa fa-image"></em></a></td>
						</tr>				
					</table>
...
<div class="modal fade" id="exampleModal<?php echo $b['id_pengaduan']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
