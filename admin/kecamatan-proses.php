...
if (isset($_GET['proses'])) {
	if ($_GET['proses']=="proses-tambah") {
		...
		mysqli_query($conn,"insert into tbl_kecamatan(nama_kecamatan,longitude,latitude,cluster_kriminalitas,cluster_lakalantas,ket_kriminalitas,ket_lakalantas) values('$nama_kecamatan','$longitude','$latitude','?','?','?','?')");
