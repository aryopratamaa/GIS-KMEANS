		...
		<div class="container">
			...
			<div class="panel panel-container" style="padding: 50px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
				<div class="bootstrap-table">
					<a href="berita-aksi?aksi=tambah" class="btn btn-primary"><i class="fa fa-plus"></i>&emsp; Tambah Data</a>
					<br/>
					<br/>
						...
						<table class="table table-hover table-bordered">
							...
							while($b=mysqli_fetch_array($brg)){
								...
								<tr>
									...
									<td class="text-center"><?php echo $b['tgl_berita'] ?></td>
									<td class="text-center"><img class="rounded-images" onerror="this.src='../assets/img/images-not.png'" src="../assets/foto/<?php echo $b['foto'] ?>" style="border-radius: 50%; width:100px; height:100px;"></td>

									<td align="justify"><?php echo $b['keterangan'] ?></td>
									
									
									<td class="text-center">
										<a href="berita-aksi?id_berita=<?php echo $b['id_berita']; ?>&aksi=ubah" class="btn btn-primary"><span class="fa fa-pencil"></span></a>

										<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='berita-proses?id_berita=<?php echo $b['id_berita']; ?>&proses=proses-hapus' }" class="btn btn-success"><span class="fa fa-trash"></span></a>
									</td>
								</tr>		
								<?php 
							}
