		...
		<div class="container" data-aos="fade-up">
			...
			<div class="panel panel-container" style="padding: 50px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
				<div class="bootstrap-table">
					<a href="kriminalitas-aksi?aksi=tambah" class="btn btn-primary"><i class="fa fa-plus"></i>&emsp; Tambah Data</a>
					<br>
					<br>
					...
					<form action="kriminalitas-proses?proses=proses-cari" method="post">
							...
							while ($a=mysqli_fetch_array($data)) {
								...
								//untuk menampilkan nilai sub berdasarkan kriteria
									...
									<td class="text-center">
										<a href="kriminalitas-aksi?id_kecamatan=<?php echo $a['id_kecamatan']; ?>&aksi=ubah" class="btn btn-primary"><span class="fa fa-pencil"></span></a>

										<a href="kriminalitas-proses?id_kecamatan=<?php echo $a['id_kecamatan']; ?>&proses=proses-hapus" class="btn btn-success"><span class="fa fa-trash"></span></a>
									</td>
								<?php } ?>
							</tr>		
							<?php 
