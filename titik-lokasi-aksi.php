					...
					<div class="panel panel-container" style="padding: 50px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
						<div class="bootstrap-table">
							...
							<div class="modal-body">
								<form action="kriminalitas-proses?proses=proses-tambah" method="post" enctype="multipart/form-data">
									...
									<div class="modal-footer">
										<a href="kriminalitas" class="btn btn-primary" type="button"data-dismiss="modal">Batal</a>&nbsp;
				...
				<div class="container" data-aos="fade-up">
					...
					<div class="panel panel-container" style="padding: 50px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
						<div class="bootstrap-table">
							...
							<form action="Kriminalitas-proses?proses=proses-ubah" method="post" enctype="multipart/form-data">
								<table class="table">
									...
									while ($baris = mysqli_fetch_array($hasil)) {
										...
										$labelK = $baris['nama_kriteria'];
										$id_kecamatan = $_GET['id_kecamatan'];
										$hasil3 = mysqli_query($conn,"SELECT * FROM tbl_kriminalitas WHERE id_kriteria='".$idK."' AND id_kecamatan='".$id_kecamatan."'");
