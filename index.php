...
if (isset($_GET['aksi'])) {
	if ($_GET['aksi']=="login") {
		...
		if ($cek > 0) {
			...
			header("location:index?pesan=gagal")or die(mysqli_error());
		}
...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90" style="border: 1px solid; background-image: url('assets/img/bg-login.png'); background-position:center; background-position-y: 20px; box-shadow: 4px 4px 8px #888888;">
				...
				<form class="login100-form validate-form flex-sb flex-w" action="index?aksi=login" method="post" enctype="multipart/form-data" style=" padding: 20px;">
