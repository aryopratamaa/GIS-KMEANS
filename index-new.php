    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <div class="row gy-4 text-center">
                ...
                <h2>SISTEM INFORMASI GEOGRAFIS PEMETAAN DAERAH RAWAN KRIMINALITAS DAN MASALAH LALU LINTAS MENGGUNAKAN
                    METODE
...
<div class="panel panel-container" style="padding: 40px; background-color: whitesmoke;">
    <div class="bootstrap-table">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                foreach (array_chunk($images, 5) as $slide) {
                ...
                ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <?php foreach ($slide as $image) { ?>
                                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $image['id_berita']; ?>">
                                    <img class="img-fluid" onerror="this.src='assets/img/images-not.png'" src="assets/foto/<?php echo $image['foto']; ?>" alt="Slide <?php echo $image['id_berita']; ?>">
                                </a>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <?php foreach ($slide as $image) { ?>
                        <div class="modal fade" id="exampleModal<?php echo $image['id_berita']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="container">
    <ol class="breadcrumb" style="padding: 20px; box-shadow: 2px 2px 10px #888888; background-color: whitesmoke;">
        ...
        <li class="breadcrumb-item active" aria-current="page" style="padding-top:5px;">Kabupaten Batu Bara, Sumatera
            Utara
        </li>
